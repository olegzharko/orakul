...
class FullSettlementApplicationTemplate extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\FullSettlementApplicationTemplate::class;
    ...
    {
        return "Заява про повний розрахунок";
    }
