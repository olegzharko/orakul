...
class ClientSpouse extends Resource
{
    ...
    {
        return "Подружжя"; // TODO: Change the autogenerated stub
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            BelongsTo::make('В шлюбі з', 'client', 'App\Nova\Client')
                ->rules('max:255')
                ->creationRules('unique:client_spouses,client_id')
                ->updateRules('unique:client_spouses,client_id,{{resourceId}}'),
...
//            Text::make('Реєстраційний номер', 'mar_reg_num'),
