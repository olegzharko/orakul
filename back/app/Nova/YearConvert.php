...
class YearConvert extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\YearConvert::class;
    ...
    {
        return "Рік"; // TODO: Change the autogenerated stub
    }
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Давальний відмінок', 'title_d')->hideFromIndex(),
            Text::make('Знахідний відмінок', 'title_z')->hideFromIndex(),
            Text::make('Орудний відмінок', 'title_o')->hideFromIndex(),
            Text::make('Місцевий відмінок', 'title_m')->hideFromIndex(),
            Text::make('Кличний відмінок', 'title_k')->hideFromIndex(),
